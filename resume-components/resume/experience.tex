...
{Developer — Behavioral Plagiarism Detection Software} % Job title
...
%---------------------------------------------------------
\cventry
{iOS Core Team — Wayfair} % Organization 
{iOS Software Engineering Intern — iMessage Security Focus} % Job title
{Boston, MA} % Location
{Summer 2018} % Date(s)
{
	\begin{cvitems} % Description(s) of tasks/responsibilities
