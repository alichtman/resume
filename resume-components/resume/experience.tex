...
{Summer 2018} % Date(s)
{
	\begin{cvitems} % Description(s) of tasks/responsibilities
		...
		\item {Our code is in production, allowing over 200,000 daily Wayfair customers to share furniture recommendations.}
		\item {Addressed challenging iOS security issues, balancing customer experience and data security.}
		\item {Led the Community Coding Day event and wrote a curriculum to teach 200+ middle schoolers basic CS concepts.}
	\end{cvitems}
}
%---------------------------------------------------------
\cventry
